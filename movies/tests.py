...
class MoviesTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # Movies (7 total so pagination triggers)
        ...
        # Existing review owned by alice on m1
    ...
    def test_review_create_requires_login(self):
        ...
        self.client.post(url, {"rating": 5, "text": "Amazing"}, follow=True)
    ...
    def test_review_update_when_exists(self):
        ...
        self.client.post(url, {"rating": 3, "text": "Changed"}, follow=True)
